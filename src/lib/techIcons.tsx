...
const TECH: Record<string, Logo> = {
  ...
  "vs code": { file: "vscode" },
  "linux / bash": { file: "linux", invert: true },
  linux: { file: "linux", invert: true },
  ...
  "cloudflare workers ai": { file: "cloudflare" },
  sqlite: { file: "sqlite" },
