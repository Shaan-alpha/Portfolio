...
export default function Certifications() {
  ...
  return (
    <section id="certifications" className="py-[120px] bg-bg1 relative z-10">
        ...
        <motion.div variants={containerVariants} initial="hidden" whileInView="visible" viewport={{ once: true, margin: "-10%" }}>
          ...
          <motion.div variants={itemVariants} className="bg-glass border border-border rounded-[22px] p-9 mt-[60px] mb-[120px] grid grid-cols-1 md:grid-cols-[1fr_auto] gap-6 items-center transition-[transform,background-color,border-color,color,box-shadow] duration-400 hover:border-border2 hover:-translate-y-1 relative overflow-hidden">
            ...
            <div className="relative z-10">
              <div className="font-display text-[26px] font-extrabold mb-1.5">Jaipur Engineering College<br/>and Research Center</div>
              <div className="text-[15px] text-muted2 mb-3.5">Bachelor of Technology in Computer Science & Engineering</div>
            ...
            <div className="relative z-10 text-center bg-gradient-to-br from-color-blue/10 to-color-purple/10 border border-border2 rounded-[22px] py-6 px-8 flex flex-col items-center">
              <div className="font-display text-[42px] font-black grad-blue">7.21</div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4.5 mt-[60px]">
            {certs.map((cert, i) => (
              ...
              >
                ...
                <div className="font-display text-[16px] font-bold leading-[1.3]">{cert.name}</div>
